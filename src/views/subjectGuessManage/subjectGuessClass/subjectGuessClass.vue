 ...
 * @LastEditTime: 2020-07-09 15:13:37
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \xkb-admin\src\views\subjectGuessManage\subjectGuessClass\subjectGuessClass.vue
-->
<template>
  <div class="subjectGuessClass">
    <pane-head :title="'命题猜想分类'" :borderBottom="true"></pane-head>
    <div class="content">
...
import { subjectGuessClass } from '@/api/modules/SubjectGuessManage'
export default {
