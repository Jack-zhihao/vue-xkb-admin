<template>
  <div class="returnCourseDetail">
    <div class="pane">
      <pane-head :title="'订单信息'" :borderBottom="true"></pane-head>
      <div class="pane-content">
        ...
        <el-row class="info-row">
          <el-col :span="5">
            <p>付款时间</p>
            <p>2019-11-05 12:40:23</p>
          </el-col>
        </el-row>
      </div>
    </div>
    <div class="pane">
      <pane-head :title="'退课信息'" :borderBottom="true"></pane-head>
      <div class="pane-content">
        <el-row class="info-row">
          <el-col :span="5">
            <p>审核状态</p>
            <p style="color: #19CBA9">已通过</p>
          </el-col>
          <el-col :span="5">
            <p>申请人</p>
            <p>果冻</p>
        ...
        <el-row class="info-row">
          <el-col :span="24">
            <p>退课凭证</p>
            <div class="imgList">
              <el-image :src="cover" width="150"></el-image>
              <el-image :src="cover" width="150"></el-image>
            </div>
          </el-col>
        </el-row>
        <el-row class="info-row border-bottom">
          <el-col :span="24">
            <p>退课凭证</p>
            <p>设计工作上最重要的是针对人们习以为常，认为理所当然的事物来做一些思考</p>
          </el-col>
        </el-row>
        <pane-head :title="'退课课程'" class="pane_head_info"></pane-head>
